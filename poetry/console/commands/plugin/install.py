...
class PluginInstallCommand(InitCommand):
    ...
    def get_elements_for_env(self, env: Env) -> Tuple["Package", "InstalledRepository"]:
    ...
    def get_vendor_directory_for_env(self, env: Env) -> Path:
        return (
            self.lib
            / "poetry"
            / "_vendor"
    ...
    def is_installed_with_installer(self) -> bool:
        from pathlib import Path
    ...
    def _install_for_installer(self, plugin) -> bool:
        from pathlib import Path
